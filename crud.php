...
if($op=='delete'){
  $id=$_GET['id'];
  $sql1="delete from jasa where id= '$id'";
...
if(in_array($ekstensi,$ekstensi1)=== true){
  ...
  if($username && $id_pemain && $email && $estimasi && $foto){
    if($op=='edit'){
      $sql1="update jasa set username='$username',id_pemain='$id_pemain',email='$email',estimasi='$estimasi',foto='$foto' where id='$id'";
      $q1=mysqli_query($koneksi,$sql1);
      if($q1){
    ...
    $sql1="insert into jasa (username,id_pemain,email,estimasi,foto) values('$username','$id_pemain','$email','$estimasi','$foto')";
     $q1= mysqli_query($koneksi,$sql1);
     if($q1){
...
<div class="nav">
        ...
        <div class="right-links">
            ...
            <a href="dibeli.php">Data Dibeli</a>
        ...
        while($r2=mysqli_fetch_array($q2)){
          ...
          ?>
            <tr>
              ...
              <td scope="row"><img src="images/<?=$foto?>" class="img-thumbnail" width="100px" height="100px"></td>
              <td scope="row">
